<%-- 
    Document   : custdetails
    Created on : 18 Mar, 2018, 12:47:51 PM
    Author     : rhlru
--%>
          ...
          try{      
           ...
           { %>
            <pre style="font-size: x-large;border-style: groove">
               <br>
           <label class="main">FIRST NAME : </label> <%= rs.getString("fname") %><br>
            <label class="main">LAST NAME : </label> <%= rs.getString("lname") %><br>
                <label class="main">EMAIL : </label> <%= rs.getString("email") %><br>
               <label class="main">MOBILE : </label> <%= rs.getString("mobile") %><br>
              <label class="main">ADDRESS : </label> <%= rs.getString("address") %><br><br>
            </pre><br>
           <%
           }
            }
