<%-- 
    Document   : adfeedback
    Created on : 18 Mar, 2018, 12:50:38 PM
    Author     : rhlru
--%>
    ...
    <body>
        ...
        <div id="header">
          ...
          try{      
           ...
           ResultSet rs=stmt.executeQuery("select name,email,subject,message from feedback");
           while(rs.next())
           { %>
...
<br>
          ...
          <label class="main">SUBJECT : </label> <%= rs.getString("subject") %><br> 
          <label class="main">MESSAGE : </label> <%= rs.getString("message") %><br><br>
          </pre>
