...
<% }
			...
			<div id="contents">
				<div class="box">
					<div>
						<div class="body">
                                                    <h1>PLACE YOUR ORDER</h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="myorders.jsp" style="font-size: larger;position: absolute;top: 230px;left: 900px">My Orders</a>
						...
						<%
                                                        ...
                                                        {   
                                                          ...
                                                          <h2>Order From : <%= rs.getString("rname") %></h2>   
                                                          <form method="post" action="mycart.jsp" style="width: 100%;position: relative ;bottom: 80px;left: 15px">
                                                              <table border="1" style="width: 100%;position: relative;bottom: 10px;right: 20px">
...
<td align="center"><input type="text" name="name1" readonly style="font-size: larger;text-align: center;border: 0px;" value="<%= rs.getString("name1") %>"><br><input type="text" name="name2" readonly style="font-size: larger;text-align: center;border: 0px;" value="<%= rs.getString("name2") %>"><br><input type="text" name="name3" readonly style="font-size: larger;text-align: center;border: 0px;" value="<%= rs.getString("name3") %>"></td>
<td align="center">
    ₹<input type="text" name="price1" readonly style="font-size: larger;text-align: center;border: 0px;" value="<%= rs.getString("price1") %>"><br>
    ₹<input type="text" name="price2" readonly style="font-size: larger;text-align: center;border: 0px;" value="<%= rs.getString("price2") %>"><br>
...
<td align="center"><input type="checkbox" name="check1" value=""><br><input type="checkbox" name="check2" value=""><br><input type="checkbox" name="check3" value=""></td>
...
<input type="hidden" name='ridd' value="<%= rs.getInt("rid") %>"/>
<center>
